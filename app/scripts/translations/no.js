...
GAS_PRICE_Desc              : 'Gas-pris er beløpet du betaler per gas-enhet. `Transaksjonsavgift = gas-pris * gas-grense` & betales til "utgraverne" for å inkludere transaksjonen din i en blokk. Høyere gas-pris = raskere transaksjon, men dyrere. Standardinnstillingen er `12 GWEI`. ',
...
/* General */
x_Access                    : 'Åpne ',
x_AddessDesc                : 'Din `adresse` kalles også for `kontonummer` eller `offentlig nøkkel`. Det er denne du sender til folk så de kan sende deg HKD eller Tokens. Find det fargerike adresse-ikonet. Forsikre deg om at det er likt med ikonet på papir-lommeboken din og ellers hver gang du oppgir adressen din. ',
...
MEW_Tagline                 : 'Open Source JavaScript Client-Side HKD Wallet ', /* Intentionally not translated */
CX_Tagline                  : 'Open Source JavaScript Client-Side HKD Wallet Chrome Extension ', /* Intentionally not translated */
...
HELP_1_Desc_1               : 'Gå til "Send HKD & Tokens"-siden. ',
...
HELP_4_Desc_2               : 'Naviger til "Send HKD & Tokens"-siden. ',
...
HELP_4CX_Title              : '4) Hvordan sender jeg ether med MyHkdWallet CX (Chrome-utvidelsen)? ',
HELP_4CX_Desc_1             : 'Først må du legge til en lommebok. Når du har gjort det, har du 2 muligheter: den kjappe "Send"-funksjonaliteten fra Chrome-utvidelsesikonet eller "Send HKD & Tokens"-siden. ',
...
HELP_4CX_Desc_12            : 'Bruk "Send HKD & Tokens"-siden ',
...
HELP_7_Desc_1               : 'Naviger til "Send HKD & Tokens"-siden. ',
...
HELP_8CX_Title              : '8) Hva skjer hvis MyHkdWallet CX (Chrome-utvidelsen) forsvinner? ',
...
HELP_8CX_Desc_2             : 'Når det er sagt, så er det **svært viktig** at du sikkerhetskopierer all din informasjon for alle lommebøkene som du har opprettet med MyHkdWallet CX. På den måten vil du fortsatt ha all nødvendig informasjon for å få tilgang til eteren din selv om noe skulle hende med MyHkdWallet CX eller datamaskinen din. Se spørsmål #2a ang. hvordan du sikkerhetskopierer lommebøkene dine. ',
HELP_8CX_Desc_3             : 'Hvis MyHkdWallet CX av en eller annen grunn skulle forsvinne fra Chrome Store, så kan du finne kildekoden på Github og laste den inn manuelt. Se #5 ovenfor. ',

HELP_9_Title                : '9) Er "Send HKD & Tokens"-siden offline? ',
...
HELP_10_Desc_11             : 'Lim inn den signerte transaksjonen i tekstfeltet i steg #3 på den tilkoblede maskinen og klikk "Send HKD & Tokens". Dette vil kringkaste transaksjonen din. ',
...
HELP_13_Desc_1              : 'Dette betyr at du ikke har nok HKD på kontoen din til å dekke gas-kostnaden. Hver transaksjon (inkludert token- og kontrakt-transaksjoner) krever gas, og gas betales med HKD. Tallet som vises er beløpet som kreves for å dekke transaksjonskostnaden i Wei (1 ETH = 10^18 Wei). Ta dette tallet, del det på `1000000000000000000`, og trekk fra HKD-beløpet som du prøvde å sende (hvis du prøvde å sende HKD). Dette vil gi deg HKD-beløpet som du mangler på (trenger å sende til) denne kontoen for å gjennomføre transaksjonen. ',
...
HELP_15_Desc_1              : 'Kontoer vil kun dukke opp i en blokkjede-utforsker når kontoen har hatt aktivitet&mdash;for eksempel, når du har overført HKD til den. ',
...
HELP_21_Title               : '21) Kan ikke hvem som helst legge inn tilfeldige private nøkler, sjekke saldoen, og sende HKD til sin egen adresse? ',
HELP_21_Desc_1              : 'Kortversjonen: ja, men å finne en konto som inneholder HKD ville tatt lengre tid enn universets levealder...så...nei. ',
...
HELP_SecCX_Title            : 'Datasikkerhet - MyHkdWallet CX (Chrome-utvidelsen) ',
...
HELP_Sec_Desc_3             : 'Vi kommer ikke til å ta pengene dine eller stjele dine private nøkler. Det er ingen ondsinnet kode på denne siden. Faktisk er "Send HKD & Tokens"-siden fullstendig klient-drevet. Det betyr at all koden blir kjørt på ** din datamaskin ** og det blir aldri lagret eller overført noe sted. ',
