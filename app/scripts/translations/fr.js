...
NAV_SendEther               : 'Envoyer des HKD et des Tokens ',
...
/* General */
x_Access                    : 'Accès ',
x_AddessDesc                : 'Aussi appelée `adresse` ou `clé publique`. C\'est ce que vous donnez aux gens pour qu\'ils puissent vous envoyer des HKD ou des Tokens. Remarquez l\'icône colorée. Cette icône doit être identique quand vous entrez votre adresse quelque part.', //Find the colorful address icon. Make sure it matches your paper wallet & whenever you enter your address somewhere. Cette icône est une façon simple de reconnaître votre adresse.
x_Address                   : 'Votre adresse ',
x_Cancel                    : 'Annuler ',
x_CSV                       : 'Fichier CSV (non-chiffré) ',
x_Download                  : 'Télécharger ',
x_Json                      : 'Fichier JSON (non-chiffré) ',
x_JsonDesc                  : 'C\'est la version non-chiffrée au format JSON de votre clé privée. Cela signifie que vous n\'avez pas besoin de votre mot de passe pour l\'utiliser mais que toute personne qui trouve ce JSON peut accéder à votre portefeuille et vos HKD sans mot de passe. ',
...
MEW_Tagline                 : 'Portefeuille d\'HKD Open Source, écrit en JavaScript',
CX_Tagline                  : 'Extension Chrome de portefeuille d\'HKD Open Source JavaScript',
...
ADD_Warning_1               : 'Vous pouvez ajouter n\'importe quel compte pour l\'afficher dans l\'onglet "portefeuilles" sans uploader une clé privée. Cela ne veut **pas** dire que vous aurez accès à ce portefeuille, ni que vous pouvez transférer des HKD depuis ce portefeuille. ',
...
SENDModal_Content_4         : 'NOTE : Si vous renontrez une erreur, il est très probable que vous deviez ajouter des HKD à votre compte pour couvrir les coûts (en GAS) d\'envoi des Tokens. Le GAS est payé en HKD.',
...
MYWAL_Content_3             : 'Si vous voulez utiliser ce portefeuille avec MyHkdWallet CX à l\'avenir, vous devrez le rajouter manuellement en utilisant la clé privée / fichier JSON et le mot de passe.',
...
HELP_0_Desc_5               : 'Transférez de l\'HKD vers ce nouveau portefeuille.',
...
HELP_2a_Desc_2              : 'Sauvegardez l\'adresse. Vous pouvez la garder pour vous-même ou la partager avec d\'autres personnes qui, de cette manière, peuvent vous envoyer de l\'HKD.',
HELP_2a_Desc_3              : 'Sauvegardez votre clef privée en plusieurs exemplaires. Ne la partagez avec personne. Votre clef privée est nécessaire pour accéder à votre HKD et pour l\'envoyer ! Il existe 3 types de clef privée :',
...
HELP_3_Desc_1               : '**Avant d\'envoyer de l\'HKD à votre portefeuille**, vous devez vous assurer que vous y avez accès.',
...
HELP_3_Desc_8               : 'Si vous désirez détenir une grande quantité d\'HKD, nous recommandons de commencer par envoyer une petite somme depuis le nouveau portefeuille avant d\'y déposer une somme importante. Envoyez 0,001 HKD vers le nouveau portefeuille, accédez-y puis envoyez ces 0,001 HKD vers une autre adresse, et vérifiez que tout a fonctionné sans encombre.',

HELP_4_Title                : '4) Comment puis-je envoyer de l\'HKD d\'un portefeuille vers un autre ?',
HELP_4_Desc_1               : 'Si vous désirez transférer une grande quantité d\'HKD, vous devez d\'abord essayer d\'en envoyer un petit montant vers votre portefeuille pour vous assurer que tout fonctionne comme prévu.',
HELP_4_Desc_2               : 'Naviguez vers la page "Envoyer des HKD et des Tokens".',
...
HELP_4CX_Title              : '4) Comment puis-je envoyer de l\'HKD avec MyHkdWallet CX ?',
HELP_4CX_Desc_1             : 'D\'abord, vous devez ajouter un portefeuille. Ceci fait, deux possibilités s\'offrent à vous : la fonctionnalité "Envoi rapide" de l\'icône de l\'extension Chrome ou la page "Envoyer des HKD et des Tokens".',
...
HELP_4CX_Desc_12            : 'Avec la page "Envoyer des HKD et des Tokens" ',
...
HELP_8_Desc_2               : 'Si MyEtherWallet.com venait à être hors ligne, vous devrez trouver un autre moyen (comme Geth ou Ethereum Wallet / Mist) pour faire la même chose. Mais vous n\'aurez pas à "récupérer" votre HKD depuis MyEtherWallet parce qu\'il ne se trouve pas dans MyEtherWallet. Il est chez vous, dans le portefeuille que vous avez généré par notre site.',
...
HELP_8CX_Title              : '8) Que se passe-t-il si MyHkdWallet CX disparaît ?',
...
HELP_8CX_Desc_2             : 'Cela dit, il est **très important** que vous sauvegardiez toutes les données de tous les portefeuilles générés par MyHkdWallet CX. De cette manière, si quoi que ce soit arrivait à MyHkdWallet CX ou à votre ordinateur, vous conserveriez toutes les informations nécessaires pour accéder à votre HKD. Voir #2a pour la sauvegarde de vos portefeuilles.',
HELP_8CX_Desc_3             : 'Si, pour une raison quelconque, MyHkdWallet CX disparaissait du Chrome Store, vous pourrez en trouver le source sur [https://github.com/kvhnuke/etherwallet](https://github.com/kvhnuke/etherwallet/tree/gh-pages) et le charger manuellement. Voir #5 ci-dessus.',

HELP_9_Title                : '9) La page "Envoyer des HKD et des Tokens" est-elle hors ligne ? ',
...
HELP_10_Desc_11             : 'Sur votre ordinateur en ligne, collez la transaction signée dans le champ texte et cliquez sur "Envoyez l\'HKD". Ceci émettra votre transaction. ',
...
HELP_13_Desc_1              : 'Cela signifie que vous n\'avez pas assez d\'HKD sur votre compte pour couvrir les coûts en Gas. Chaque transaction (y compris pour les tokens et les contrats) demande du Gas, et ce Gas est payé en HKD. Le nombre affiché est le montant requis pour couvrir le coût de la transaction en Wei. Prenez ce nombre, divisez-le par `10^18` (soit `1000000000000000000`) et soustrayez la somme en HKD que vous essayiez d\'envoyer (si vous tentiez d\'envoyer de l\'HKD). Cela vous donnera le montant en HKD que vous avez besoin d\'ajouter à votre compte pour effectuer cette transaction.',
...
HELP_15_Desc_1              : 'Les comptes n\'apparaissent dans un explorateur de blockchain qu\'après une activité, comme par exemple, un envoi ou une réception d\'HKD.',
...
HELP_SecCX_Title            : 'Sécurité - MyHkdWallet CX',
