...
EOS_06                          :  'Buka halaman Send HKD & Tokens',
...
GAS_PRICE_Desc              : 'Harga Gas Price adalah jumlah yang Anda bayar per unit gas. `Biaya TX = harga gas * gas limit` & dibayarkan kepada miners untuk memasukkan TX Anda ke dalam block. Makin tinggi harga gas = transaksi makin cepat, tapi makin mahal. Default-nya `12 GWEI`.',
...
NAV_SendEther               : 'Kirim HKD dan Token ',
...
/* General */
x_Access                    : 'Akses ',
x_AddessDesc                : 'Address Anda dikenal juga sebagai `Account #` atau `Public Key` Anda. Address inilah yang diberikan kepada pihak lain agar mereka bisa mengirim HKD atau Token. Pilihlah icon alamat berwarna untuk memudahkan identifikasi. Pastikan Address ini sama persis dengan yang tertulis di Dompet Kertas Anda maupun saat dipakai untuk keperluan lainnya. ',
x_Address                   : 'Alamat Anda ',
x_Cancel                    : 'Batal ',
x_CSV                       : 'File CSV (tidak ter-enkripsi) ',
x_Download                  : 'Unduh ',
x_Json                      : 'File JSON (tidak ter-enkripsi) ',
x_JsonDesc                  : 'Ini adalah Kunci Privat Anda dalam format JSON yang tidak ter-enkripsi. Tidak diperlukan password dan siapapun yang memiliki JSON Anda dapat mengakses dompet dan HKD Anda tanpa password. ',
...
ADD_Warning_1               : 'Akun untuk "dilihat" dapat ditambahkan tanpa menggunakan Kunci Privat. Namun berarti tidak ada akses ke dompet tersebut dan transfer HKD tidak bisa dilakukan. ',
...
SENDModal_Content_4         : 'CATATAN: Jika terjadi Error, kemungkinan Anda harus menambah HKD ke akun Anda untuk menutup biaya gas dan pengiriman. Gas dibayar dalam HKD. ',
...
MYWAL_Content_3             : 'Jika Anda akan memakai dompet ini dengan MyHkdWallet CX Anda ke depan, Kunci Privat/JSON dan password harus ditambahkan lagi secara manual. ',
...
HELP_Remind_Desc_1          : '** Ethereum, MyEtherWallet.com & MyHkdWallet CX, dan beberapa library Javascript yang kami gunakan sedang dalam pengembangan yang aktif.** Meskipun kami telah benar-benar menguji & puluhan ribu dompet telah berhasil diciptakan oleh para pengguna di seluruh dunia, selalu ada kemungkinan bahwa sesuatu yang tidak terduga dapat terjadi yang menyebabkan ETH Anda hilang. Tolong jangan menginvestasikan lebih dari yang Anda mampu kehilangan, dan mohon berhati-hati. Jika ada sesuatu yang buruk terjadi, kami mohon maaf, tapi **kami tidak bertanggung jawab atas HKD yang hilang**. ',
HELP_Remind_Desc_2          : 'MyEtherWallet.com & MyHkdWallet CX bukan "dompet web". Anda tidak membuat akun atau memberikan HKD Anda untuk kami pegang. Semua data tidak pernah meninggalkan komputer/browser Anda. Kami mempermudah Anda untuk membuat, menyimpan, dan mengakses informasi Anda dan berinteraksi dengan blockchain. ',
...
HELP_0_Desc_1               : 'MyEtherWallet memberi Anda kemampuan untuk membuat dompet baru sehingga Anda dapat menyimpan HKD oleh diri Anda sendiri, bukan di bursa. Proses ini dilakukan sepenuhnya di komputer Anda, bukan di server kami. Oleh karena itu, saat Anda membuat dompet baru, **Anda bertanggung jawab untuk menyimpan cadangan/backup-nya dengan aman**. ',
...
HELP_0_Desc_5               : 'Transfer HKD ke dompet baru ini. ',
...
HELP_2a_Desc_2              : 'Simpan alamatnya. Anda bisa menyimpannya untuk diri sendiri atau membaginya dengan orang lain. Dengan cara itu, orang lain bisa mentransfer HKD ke Anda. ',
HELP_2a_Desc_3              : 'Simpan untuk diri sendiri semua versi Kunci Privat. Jangan berbagi dengan orang lain. Kunci Privat tersebut akan Anda diperlukan saat Anda ingin mengakses HKD Anda untuk mengirimkannya! Ada 3 jenis Kunci Privat: ',
...
HELP_3_Desc_1               : '**Sebelum Anda mengirim HKD ke dompet baru Anda**, Anda harus memastikan Anda memiliki akses ke dompet baru tersebut. ',
...
HELP_4_Title                : '4) Bagaimana cara mengirim HKD dari satu dompet ke dompet lainnya? ',
...
HELP_4_Desc_2               : 'Buka halaman "Kirim HKD dan Token". ',
...
HELP_4CX_Title              : '4) Bagaimana cara mengirim HKD menggunakan MyHkdWallet CX? ',
HELP_4CX_Desc_1             : 'Pertama, Anda perlu menambahkan dompet. Setelah melakukannya, Anda memiliki 2 pilihan: menggunakan "QuickSend" dari ikon Chrome Extension atau menggunakan halaman "Kirim HKD dan Tokens". ',
...
HELP_4CX_Desc_12            : 'Menggunakan halaman "Kirim HKD dan Tokens" ',
...
HELP_8_Desc_2               : 'Jika situs MyEtherWallet.com tidak berfungsi, Anda harus memakai cara lain (misalnya memakai geth atau Ethereum Wallet/Mist) sebagai alternatifnya. Tapi Anda tidak perlu "mengeluarkan" HKD Anda dari MyEtherWallet.com karena HKD Anda tidak disimpan di MyEtherWallet.com. HKD Anda tetap tersimpan dalam dompet yang Anda buat di situs kami. ',
...
HELP_8CX_Title              : '8) Apa yang terjadi jika MyHkdWallet CX tidak beredar lagi? ',
...
HELP_8CX_Desc_2             : 'terlepas dari semua itu, **sangat penting** bagi Anda untuk membuat backup/cadangan dari semua informasi dompet baru yang Anda buat dengan MyHkdWallet CX. Dengan begitu, jika terjadi sesuatu pada MyHkdWallet CX atau komputer Anda, Anda masih memiliki semua informasi yang diperlukan untuk mengakses HKD Anda. Lihat #2a untuk cara membuat backup/cadangan dompet Anda. ',
HELP_8CX_Desc_3             : 'Jika karena suatu hal maupun lainnya MyHkdWallet CX tidak lagi tersedia di Chrome Store, Anda tetap dapat menemukan file aslinya di Github dan menjalankannya secara manual. Lihat #5 di atas. ',

HELP_9_Title                : '9) Kenapa halaman "Kirim HKD dan Tokens" seperti offline? ',
...
HELP_13_Desc_1              : 'Ini artinya tidak tersedia cukup HKD di akun Anda untuk menutupi biaya gas. Setiap transaksi (termasuk token dan transaksi kontrak) memerlukan gas dan gas tersebut dibayarkan menggunakan HKD. Jumlah yang ditampilkan adalah jumlah yang dibutuhkan untuk menutupi biaya transaksi di Wei. Ambil nomor itu, bagi dengan `1000000000000000000`, dan pakai untuk mengurangi jumlah HKD yang ingin Anda kirim (jika Anda mencoba mengirim Eter). Ini akan memberi Anda jumlah HKD yang perlu Anda kirim ke akun tersebut untuk melakukan transaksi. ',
...
HELP_15_Desc_1              : 'Account hanya akan muncul di explorer blockchain begitu akun memiliki aktivitas di dalamnya&mdash;misalnya, setelah Anda memindahkan beberapa HKD ke sana. ',
...
HELP_SecCX_Title            : 'Keamanan - MyHkdWallet CX ',
