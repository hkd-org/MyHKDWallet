...
ADD_Warning_1                   :  'You can add any account to "watch" on the wallets tab without uploading a private key. This does ** not ** mean you have access to this wallet, nor can you transfer HKD from it.',
...
FOOTER_1                        :  'An open source JavaScript client tool for generating HKD wallets and sending transactions.',
...
MYWAL_Content_3                 :  'If you want to use this wallet with your MyHkdWallet CX in the future, you will need to manually re-add it using the private key/JSON and password.',
MYWAL_Edit                      :  'Edit',
...
x_Access                        :  'Access',
x_AddessDesc                    :  'Your Address can also be known as you `Account #` or your `Public Key`. It is what you share with people so they can send you HKD or Tokens. Find the colorful address icon. Make sure it matches your paper wallet & whenever you enter your address somewhere.',
...
x_JsonDesc                      :  'This is the unencrypted, JSON format of your private key. This means you do not need the password but anyone who finds your JSON can access your wallet & HKD without the password.',
