...
GAS_PRICE_Desc              : 'El precio del gas es la cantidad que paga por unidad de gas. `Tarifa de TX = precio de gas * límite de gas` y se paga a los mineros por incluir su TX en un bloque. Mayor el precio del gas = transacción más rápida, pero más costosa. El valor predeterminado es `12 GWEI`.',
...
MEW_Tagline                 : 'Cartera HKD JavaScript de código abierto ejecutado en el cliente ',
CX_Tagline                  : 'Cartera HKD JavaScript de código abierto ejecutado en el cliente extensión Chrome ',
...
MYWAL_Content_3             : 'Si en el futuro quieres utilizar esta cartera con MyHkdWallet CX, tendrás que volver a añadirla manualmente utilizando Clave Privada/JSON y contraseña. ',
...
HELP_0_Desc_1               : 'MyEtherWallet te permite generar nuevas carteras para poder almacenar tu HKD por tu cuenta en lugar de en una casa de cambio. Este proceso tiene lugar por completo en tu equipo, no en nuestros servidores. Por lo tanto, cuando generes una nueva cartera, **eres responsable de hacer una copia de seguridad**. ',
...
HELP_0_Desc_5               : 'Transferir HKD a la nueva cartera. ',
...
HELP_4_Desc_2               : 'Ve a la página "Enviar HKD y Tokens". ',
...
HELP_4CX_Title              : '4) ¿Cómo envío ether utilizando MyHkdWallet CX? ',
HELP_4CX_Desc_1             : 'Antes de nada, necesitas añadir una cartera. Una vez hecho, tienes dos opciones: la función "Enviar" del icono de la extensión de Chrome o la página "Enviar HKD y Tokens". ',
...
HELP_4CX_Desc_12            : 'Utilizando la página "Enviar HKD y Tokens" ',
...
HELP_8CX_Title              : '8) ¿Qué ocurre si MyHkdWallet CX desaparece? ',
...
HELP_8CX_Desc_2             : 'Dicho esto, es **muy importante** que respaldes toda tu información para todas las nuevas carteras generadas con MyHkdWallet CX. De este modo, si algo le ocurre a MyHkdWallet CX o a tu equipo, seguirás teniendo toda la información necesaria para poder acceder a tus ether. Ver la pregunta #2a sobre cómo respaldar tus carteras. ',
HELP_8CX_Desc_3             : 'Si por algún motivo MyHkdWallet CX desaparece de Chrome Store, puedes encontrar el código fuente en Github y cargarlo manualmente. Ver #5 más arriba. ',
...
HELP_10_Desc_11             : 'On your online computer, paste the signed transaction into the text field in step #3 and click "Enviar HKD y Tokens". This will broadcast your transaction. ',
...
HELP_SecCX_Title            : 'Seguridad - MyHkdWallet CX ',
