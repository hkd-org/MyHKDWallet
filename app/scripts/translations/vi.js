...
GAS_PRICE_Desc              : 'Gas Price is the amount you pay per unit of gas. `TX fee = gas price * gas limit` & is paid to miners for including your TX in a block. Higher the gas price = faster transaction, but more expensive. Default is `12 GWEI`.',
...
NAV_SendEther               : 'Gửi HKD và Tokens ',
...
MEW_Tagline                 : 'Open Source JavaScript Client-Side HKD Wallet ',
CX_Tagline                  : 'Open Source JavaScript Client-Side HKD Wallet Chrome Extension ',
...
MYWAL_Content_3             : 'Nếu bạn muốn sử dụng địa chỉ Ví này với MyHkdWallet CX trong tương lai, bạn sẽ cần phải tự thêm vào lại bằng cách sử dụng tập tin Private Key / JSON và mật khẩu. ',
...
HELP_Remind_Desc_1          : '**Ethereum, MyEtherWallet.com & MyHkdWallet CX, và các nền tảng khác từ Javascript libraries mà chúng tôi sử dụng đang được phát triển một cách tích cực.** Mặc dù toàn bộ đã được chúng tôi kiễm tra rất kỹ lưỡng và hàng chục nghìn địa chỉ Ví đã được tạo thành công từ người sử dụng trên toàn cầu, nhưng vẫn có những vấn đề có thể xảy ra làm cho ETH của bạn bị mất đi. Xin vui lòng không nên đầu tư với số tiền nhiều hơn khả năng mà bạn đã cho rằng nó sẽ mất và hãy luôn cẩn thận. Trong trường hợp rủi ro xảy ra, chung tôi rất chân thành xin lỗi. Tuy nhiên **Chúng tôi sẽ không chịu bất cứ một trách nhiệm nào đối với số lượng HKD mà bạn đã bị mất!**. ',
HELP_Remind_Desc_2          : 'MyEtherWallet.com & MyHkdWallet CX không phải "Ví Web". Vì vậy bạn không tạo tài khoản sau đó gửi số HKD của bạn cho chúng tôi dễ giữ hộ. Toàn bộ Dữ liệu sẽ không bao giờ bị rò rỉ ra khỏi máy tính/trình duyệt của bạn. Chúng tôi xây dựng nó nhằm giúp người sử dụng có thể đễ dàng tạo mới, lưu trữ và truy cập thông tin Ví của bạn và tương tác với Blockchain. ',
...
HELP_0_Desc_1               : 'MyEtherWallet giúp bạn có khả năng tạo Ví mới dùng dễ lưu trữ số lượng HKD của ban bởi chính mình, Ví được tạo ra không nằm trên bất cứ một sàn giao dịch nào. Quá trình tạo Ví điễn ra hoàn toàn trên máy tính cá nhân của bạn chứ không phải trên hệ thống máy chủ của chúng tôi. Do đó, khi bạn khởi tạo một Ví mới, **bạn chịu trách nhiệm hoàn toàn về vấn đề sao lưu dữ liệu đối với Ví được tạo**. ',
...
HELP_0_Desc_5               : 'Gửi HKD đến Ví mới này. ',
...
HELP_2a_Desc_2              : 'Lưu lại địa chỉ Ví. Bạn có thể giữ nó cho chính mình hoặc chia sẽ nó cho bất cứ ai. Người khác có thể gửi HKD cho bạn thông qua địa chỉ Ví của bạn. ',
HELP_2a_Desc_3              : 'Private key. Không được chia sẽ Private key cho bất cứ ai. Private key rất cần thiết khi bạn muốn truy cập vào Ví và Gửi đi một lượng HKD! hiện tại có 3 phiên bản lưu trữ dành cho Private Key: ',
...
HELP_3_Desc_1               : '**Trước khi bạn gửi số lượng HKD vô Ví mới của bạn**, bạn nên chắc chắn rằng bạn đã truy cập vào Ví thành công. ',
...
HELP_4_Title                : '4) Làm thế nào dễ gửi HKD từ Ví này sang Ví khác ? ',
HELP_4_Desc_1               : 'Nếu như bạn dự định dễ chuyển một số lượng lớn HKD, bạn nên gửi đi một lượng nhỏ đến Ví của bạn dễ thử nghiệm, nhằm xác định chắc chắn tất cả chức năng đều hoạt động đúng như dự định. ',
HELP_4_Desc_2               : 'Đi đến trang "Gửi HKD và Tokens". ',
...
HELP_4_Desc_7               : 'Điền số lượng HKD mà bạn muốn gửi đi.Hoặc bạn có thể chọn vào phần "Gửi toàn bộ số dư" nếu bạn muốn chuyển đi toàn bộ số HKD mà bạn hiện có trong tài khoản. ',
...
HELP_4CX_Title              : '4) Làm thế nào dễ gửi đi HKD bằng cách sử dụng MyHkdWallet CX? ',
HELP_4CX_Desc_1             : 'Trước tiên, bạn cần phải thêm Ví của bạn vào. Sau khi thực hiện xong, Bạn sẽ có 2 lựa chọn: Chức năng "Gửi Nhanh" từ biểu tượng nằm trên thanh công cụ tiện ích của Google Chrome hoặc chọn vào "Gửi HKD và Tokens" dễ đi đến trang trình duyệt. ',
...
HELP_4CX_Desc_7             : 'Điền số lượng HKD mà bạn muốn gửi đi.Hoặc bạn có thể chọn vào phần "Gửi toàn bộ số dư" nếu bạn muốn chuyển đi toàn bộ số HKD mà bạn hiện có trong tài khoản. ',
...
HELP_4CX_Desc_12            : 'Sử dụng trang "Gửi HKD và Tokens" ',
...
HELP_7_Desc_1               : 'Đi đến trang "Gửi HKD và Tokens". ',
...
HELP_7_Desc_14              : 'Sau đó một thông báo sẽ xuất hiện. Xác thực lại số lượng HKD và địa chỉ đến. sau đó nhấn vào nút  "Có, Tôi chắc chắn! Hãy thực hiện giao dịch.". ',
...
HELP_8_Desc_2               : 'Nếu MyEtherWallet.com bị sập, bạn sẽ phải tìm một giải pháp khác (như là geth hoặc Ví Ethereum / Mist) dễ tiếp tục thực hiện giao dịch. Nhưng bạn không cần thiết phải "Mang" HKD của bạn ra khỏi MyEtherWallet bởi vì số HKD đó không nằm trong MyEtherWallet. Bởi vì số HKD đó đang nằm trong Ví Ethereum được khởi tạo thông qua trang của chúng tôi. ',
...
HELP_8CX_Title              : '8) Những gì sẽ xảy ra néu MyHkdWallet CX hoàn toàn biến mất? ',
...
HELP_8CX_Desc_2             : 'Điều đó cho thấy tầm **quan trọng** đối với việc sao lưu toàn bộ thông tin và dữ liệu Ví mới được khởi tạo từ bạn tại trang MyHkdWallet CX. Và việc sao lưu dữ liệu là cách dự phòng tốt khi những vấn đề xấu có thể xảy ra đối với MyHkdWallet CX hoặc máy tính của bạn, và nó giúp bạn có toàn bộ thông tin cần thiết dễ bạn có thể truy cập vào Ví và quản lý được số HKD của bạn. xem lại phần #2a dễ rõ hơn về cách sao lưu dữ liệu. ',
HELP_8CX_Desc_3             : 'Nếu vì một lý do bất kì buộc MyHkdWallet CX không tồn tại trên kho tiện ích của Chrome, bạn có thể tìm thấy mã nguồn trên Github và tải về máy của bạn. Xem phần #5 ở trên. ',

HELP_9_Title                : '9) Có phải trang "Gửi HKD" là trang offline? ',
...
HELP_10_Desc_11             : 'Trên máy tính online của bạn, bạn hãy dán chữ ký giao dịch vào khung điền văn bản tại bước #3 và chọn nút "Gửi HKD". Việc làm này sẽ phát sóng đi giao dịch của bạn. ',
...
HELP_15_Desc_1              : 'Tài khoản của bạn chỉ tồn tại duy nhất trên một Blockchain Explorer và tài khoản được kích hoạt khi bởi chính nó khi bạn dùng tài khoản đó và chuyển HKD vào tức khắc tài khoản sử dụng sẽ hiển thị trên hệ thống Blockchain Explorer thích hợp. ',
...
HELP_21_Title               : '21) có thể xảy ra trường hợp có một cá nhân nào đó sử dụng ngẫu nhiên một Private key dễ thấy được số dư tài khoản của một người khác và chuyển số HKD đó vào địa chỉ mà cá nhân dó sở hữu hay không? ',
HELP_21_Desc_1              : 'Đối với phiên bản ngắn: Điều đó có thể xảy ra, nhưng việc chọn ngẫu nhiên dễ nhằm tìm kiếm một tài khoản chứa HKD là một việc làm mất rất nhiều thời gian và cũng có thể mất cả vài chục năm dễ đạt được mục đích đó. bởi vậy trường hợp này được coi là rất khó dễ xảy ra. ',
...
HELP_SecCX_Title            : 'Bảo mật - MyHkdWallet CX ',
