...
GAS_PRICE_Desc              : 'Il prezzo gas è la somma che paghi per unità di gas. `Commissione transazione = prezzo gas * limite gas` e si paga ai *miner* perché includano la tua transazione in un blocco. Più alto il prezzo gas = più veloce la transazione, ma più costosa. Di default è `12 GWEI`.',
...
ADD_Warning_1               : 'Puoi aggiungere qualunque conto da "osservare" nella scheda dei portafogli senza caricare una chiave privata. Ciò ** non ** significa che avrai accesso a quel portafoglio, né che potrai trasferire gli HKD lì contenuti. ',
...
MYWAL_Content_3             : 'Se vorrai utilizzare questo portafoglio con MyHkdWallet CX in futuro, dovrai ri-aggiungerlo manualmente tramite la chiave privata/JSON e password. ',
...
HELP_4CX_Title              : '4) Come invio degli ether utilizzando MyHkdWallet CX? ',
...
HELP_8CX_Title              : '8) Che succede se MyHkdWallet CX sparisce? ',
...
HELP_8CX_Desc_2             : 'Detto ciò, è **molto importante** che tu faccia un backup di tutte le informazioni relative a ogni nuovo portafoglio generato con MyHkdWallet CX. In questo modo se succede qualcosa a MyHkdWallet CX or al tuo computer avrai ancora tutte le informazioni necessarie ad accedere ai tuoi ether. Vedi la domanda n. 2a per come salvare i tuoi portafogli. ',
HELP_8CX_Desc_3             : 'Se per qualche ragione MyHkdWallet CX sparisce dal Chrome Store, puoi trovare i sorgenti su Github e caricare l\'estensione manualmente. Vedi la domanda n. 5 qui sopra. ',
...
HELP_SecCX_Title            : 'Sicurezza - MyHkdWallet CX ',
