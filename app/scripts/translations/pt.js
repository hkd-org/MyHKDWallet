...
NAV_SendEther               : 'Enviar HKD & Tokens ',
...
MEW_Tagline                 : 'Fonte aberta JavaScript para o client-side da Carteira HKD ',
CX_Tagline                  : 'Fonte Aberta JavaScript para o client-side da Carteira HKD para extensão do Chrome ',
...
ADD_Warning_1               : 'Você pode adicionar qualquer conta para "ver" na tab de carteiras sem fazer o upload da chave privada. Isso significa que você ** não **  tem acesso a essa carteira, nem pode transferir HKD a partir dela. ',
...
MYWAL_Content_3             : 'Se pretender utilizar esta carteira com o MyHkdWallet CX no futuro, terá de voltar a adicioná-la manualmente utilizando a chave privada/JSON e a palavra-passe. ',
...
HELP_4_Desc_2               : 'Navigate to the "Enviar HKD & Tokens" page. ',
...
HELP_4CX_Desc_1             : 'First, you need to add a wallet. Once you have done that, you have 2 options: the "QuickSend" functionality from the Chrome Extension icon or the "Enviar HKD & Tokens" page. ',
...
HELP_4CX_Desc_12            : 'Using "Enviar HKD & Tokens" Page ',
...
HELP_7_Desc_1               : 'Navigate to the "Enviar HKD & Tokens" page. ',
...
HELP_9_Title                : '9) Is the "Enviar HKD & Tokens" page offline? ',
