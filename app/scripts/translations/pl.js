...
NAV_SendEther               : 'Wyślij HKD i Tokeny ',
...
MYWAL_Content_3             : 'Jeśli będziesz chciał w przyszłości używać ten portfel ze swoim MyHkdWallet CX, będziesz musiał go ponownie dodać używając klucza prywatnego/pliku JSON i hasła. ',
...
HELP_4_Title                : '4) Jak wysłać HKD z jednego portfela na inny? ',
...
HELP_4_Desc_2               : 'Przejdź na zakładkę "Wyślij HKD". ',
...
HELP_4CX_Title              : '4)Jak wysłać HKD używając MyHkdWallet CX? ',
HELP_4CX_Desc_1             : 'Najpierw musisz dodać portfel. Po dodaniu portfela masz 2 możliwości do wyboru: funkcja "Wyślij" z ikony Rozszerzenia Chrome lub zakładka "Wyślij HKD" ze strony "Moje Portfele". ',
...
HELP_4CX_Desc_12            : 'Używając zakładki "Wyślij HKD" ',
...
HELP_7_Desc_1               : 'Przejdź na zakładkę "Wyślij HKD i Tokeny". ',
...
HELP_8CX_Title              : '8) Co się stanie jeżeli MyHkdWallet CX zniknie? ',
...
HELP_8CX_Desc_2             : 'Z tego powodu, jest **niezmiernie ważnym** aby wykonywać kopie bezpieczeństwa wszystkich nowych portfeli wygenerowanych za pomocą MyHkdWallet CX. W ten sposób, jeżeli cokolwiek stanie się MyHkdWallet CX lub Twojemu komputerowi, wciąż będziesz miał wszelkie niezbędne informacje potrzebne aby odzyskać dostęp do Twoich portfeli. Zobacz punkt 2a aby dowiedzieć się jak wykonać kopie bezpieczeństwa. ',
HELP_8CX_Desc_3             : 'Jeżeli z jakiegoś powodu MyHkdWallet CX zniknie z Chrome Store, możesz wciąż znaleźć kod źródłowy na Github\'ie i załadować manualnie do Chrome. Zobacz pkt. 5 powyżej. ',

HELP_9_Title                : '9) Czy zakładka "Wyślij HKD" działa offline? ',
...
HELP_13_Desc_1              : 'Oznacza to, że nie posiadasz wystarczającej ilości HKD na koncie, aby pokryć koszty paliwa. Każda transakcja (przesyłanie tokenów lub interakcja z kontraktem) wymaga paliwa, które jest opłacane w HKD\'ach. Wyświetlona wartość jest ilością potrzebną na pokrycie kosztów transakcji w Wei\'ach. Podziel tą liczbę przez `1000000000000000000` i odejmij wartość HKD, którą chciałeś wysłać (jeśli wysyłałeś HKD). Otrzymasz wartość, jaką musisz przesłać na swoje konto, aby wykonać transakcję.',
...
HELP_SecCX_Title            : 'Bezpieczeństwo - MyHkdWallet CX ',
