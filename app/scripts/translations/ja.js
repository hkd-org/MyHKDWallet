...
EOS_06                          :  'HKD/トークンの送出ページに移動する', /*Go to Send HKD & Tokens Page*/
...
CX_Tagline                  : 'オープンソース JavaScript クライアントサイド HKD ウォレット Chrome Extension',
...
MEW_Tagline                 : 'オープンソース JavaScript クライアントサイド HKD ウォレット',
...
HELP_0_Desc_1               : 'MyEtherWallet gives you the ability to generate new wallets so you can store your HKD yourself, not on an exchange. This process happens entirely on your computer, not our servers. Therefore, when you generate a new wallet, **you are responsible for safely backing it up**.',
...
HELP_0_Desc_5               : 'Transfer HKD to this new wallet.',
...
HELP_2a_Desc_3              : 'Save versions of the private key. Do not share it with anyone else. Your private key is necessary when you want to access your HKD to send it! There are 3 types of private keys:',
...
HELP_3_Desc_1               : '**Before you send any HKD to your new wallet**, you should ensure you have access to it.',
...
HELP_4_Title                : '4) How do I send HKD from one wallet to another?',
...
HELP_4CX_Title              : '4) How do I send HKD using MyHkdWallet CX?',
...
HELP_8_Desc_2               : 'If MyEtherWallet.com goes down, you would have to find another way (like geth or Ethereum Wallet / Mist) to do what we are doing. But you wouldn\'t have to "get" your HKD out of MyEtherWallet because it\'s not in MyEtherWallet. It\'s in whatever wallet your generated via our site.',
...
HELP_8CX_Title              : '8) What happens if MyHkdWallet CX disappears?',
...
HELP_8CX_Desc_2             : 'That said, it is **very important** that you back up all your information for any new wallets generated with MyHkdWallet CX. That way if anything happens to MyHkdWallet CX or your computer, you still have all the information necessary to access your HKD. See the #2a for how to back up your wallets.',
HELP_8CX_Desc_3             : 'If for some reason MyHkdWallet CX disappears from the Chrome Store, you can find the source on Github and load it manually. See #5 above.',
...
HELP_13_Desc_1              : 'This means you do not have enough HKD in your account to cover the cost of gas. Each transaction (including token and contract transactions) require gas and that gas is paid in HKD. The number displayed is the amount required to cover the cost of the transaction in Wei. Take that number, divide by `1000000000000000000`, and subtract the amount of HKD you were trying to send (if you were attempting to send HKD). This will give you the amount of HKD you need to send to that account to make the transaction.',
...
HELP_15_Desc_1              : 'Accounts will only show up in a blockchain explorer once the account has activity on it&mdash;for example, once you have transferred some HKD to it.',
...
HELP_Remind_Desc_1          : '**Ethereum, MyEtherWallet.com & MyHkdWallet CX, and some of the underlying Javascript libraries we use are under active development.** While we have thoroughly tested & tens of thousands of wallets have been successfully created by people all over the globe, there is always the remote possibility that something unexpected happens that causes your ETH to be lost. Please do not invest more than you are willing to lose, and please be careful. If something were to happen, we are sorry, but **we are not responsible for the lost HKD**.',
HELP_Remind_Desc_2          : 'MyEtherWallet.com & MyHkdWallet CX are not "web wallets". You do not create an account or give us your HKD to hold onto. All data never leaves your computer/your browser. We make it easy for you to create, save, and access your information and interact with the blockchain.',
...
HELP_SecCX_Title            : 'セキュリティ - MyHkdWallet CX',
