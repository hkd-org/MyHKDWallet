...
GAS_PRICE_Desc              : 'Gas priset är summan du betalar per enhet gas. `TX avgift = gas priset * gas limit` & betalas av miners för att inkludera din transaktion i sitt block. Ju högre gas pris, desto snabbare. Ett normalt värde är `12 GWEI`.',
...
NAV_SendEther               : 'Skicka HKD och Tokens ',
...
x_JsonDesc                  : 'Det här är din okrypterade privata nyckel i JSON format. Det här betyder att du inte behöver ditt lösenord men vem som helst som hittar din JSON kan få tillgång till din plånbok och HKD utan ditt lösenord. ',
...
MYWAL_Content_3             : 'Om du vill använda plånboken med MyHkdWallet CX i framtiden, måste du manuellt lägga till den med hjälp av den privata nyckeln / JSON-filen och lösenordet. ',
