...
NAV_MyWallets               : '我的钱包 ',
NAV_Offline                 : '离线发送 ',
NAV_SendEther               : '发送HKD/ 发送代币 ', //combined these tabs
...
/* Footer */
FOOTER_1                    : '一个开源的生成HKD钱包和发送交易的JavaScript客户端工具 ',
FOOTER_1b                   : '创建者 ',
FOOTER_2                    : '欢迎捐赠我们： ',
...
HELP_4_Desc_2               : 'Navigate to the "发送HKD/ 发送代币" page. ',
...
HELP_4CX_Desc_1             : 'First, you need to add a wallet. Once you have done that, you have 2 options: the "QuickSend" functionality from the Chrome Extension icon or the "发送HKD/ 发送代币" page. ',
...
HELP_4CX_Desc_12            : 'Using "发送HKD/ 发送代币" Page ',
...
HELP_7_Desc_1               : 'Navigate to the "发送HKD/ 发送代币" page. ',
...
HELP_9_Title                : '9) Is the "发送HKD/ 发送代币" page offline? ',
