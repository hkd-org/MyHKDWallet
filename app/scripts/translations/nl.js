...
GAS_PRICE_Desc              : 'Gas Prijs is het bedrag dat je betaald per unit gas. `TX vergoeding = gas prijs * gas limiet` & wordt betaald aan de miners om jouw TX in een blok op de blockchain op te nemen. Des te hoger de gas prijs = de sneller je transactie, maar ook duurder. Standaard is `12 GWEI`.',
...
NAV_SendEther               : 'Verzend HKD & Tokens ',
...
x_AddessDesc                : 'Je Adres wordt ook wel je `Account #` of je Publieke Sleutel ("Public Key") genoemd. Dit is wat je deelt met anderen zodat ze je HKD of Tokens kunnen toesturen. Zie ook je kleurrijke adres icoon. Zorg ervoor dat het matched met je paper wallet & waar dan ook wanneer je je adres ergens invoerd. Dit icoon is een makkelijke manier om je adres te herkennen. ',
x_Address                   : 'Je Adres ',
x_Cancel                    : 'Annuleren ',
x_CSV                       : 'CSV bestand (onversleuteld) ',
x_Download                  : 'Download ',
x_Json                      : 'JSON Bestand (onversleuteld) ',
x_JsonDesc                  : 'Dit is het onversleutelde, JSON formaat van je prive sleutel ("Private Key"). Dit betekend dat je het wachtwoord niet nodig hebt, maar ook dat een ieder die je JSON bestand vind toegang heeft tot je wallet & HKD zonder wachtwoord. ',
...
/* Header */
CX_Tagline                  : 'Open Source JavaScript Client-Side HKD Wallet Chrome Extensie ',
...
ADD_Warning_1               : 'Je kunt elk account toevoegen als "bekijken" in het wallets tabblad zonder de prive sleutel te uploaden. Dit betekend ** niet ** dat je toegang hebt tot deze wallet, noch dat je er HKD vanuit kunt versturen. ',
...
MYWAL_Content_3             : 'Als je deze wallet in de toekomst nog wilt gebruiken met MyHkdWallet CX, zul je het met de hand moeten toevoegen door gebruik te maken van de prive sleutel/JSON en wachtwoord. ',
...
HELP_Remind_Desc_1          : '**Ethereum, MyEtherWallet.com & MyHkdWallet CX, en enkele onderliggende Javascript libraries waar we gebruik van maken zijn onderheving aan active ontwikkeling.** Hoewel we grondig testen & er inmiddels tienduizenden wallets succesvol zijn aangemaakt door mensen over de hele wereld, blijft er altijd een geringe kans dat iets er onverwachts optreedt waardoor je je ether kunt verliezen. Investeer alsjeblieft niet meer dan dat je bereid bent om te verliezen, en wees voorzichtig. Zou er onverhoopt toch iets gebeuren vinden we dat zeer spijtig, echter **zullen wij nooit verantwoordelijk zijn voor de verloren HKD**. ',
HELP_Remind_Desc_2          : 'MyEtherWallet.com & MyHkdWallet CX zijn geen "web wallets". Je maakt bij ons geen account aan noch geef je ooit je HKD aan ons in bezit. Alle gegevens verlaten nooit je computer/je browser. We helpen je alleen gemakkelijk toegang te verkrijgen tot de blockchain zodat je er informatie in kunt opslaan en kunt uitlezen. ',
...
HELP_0_Desc_5               : 'Verzend HKD naar dit nieuwe wallet. ',
...
HELP_3_Desc_1               : 'Zorg **voordat je enige HKD naar je wallet verstuurd** dat je controleerd dat je er toegang toe hebt. ',
...
HELP_4_Title                : '4) Hoe stuur ik HKD van het ene wallet naar het ander? ',
...
HELP_4_Desc_2               : 'Navigeer naar de "Verzend HKD en Tokens" pagina. ',
...
HELP_4CX_Title              : '4) Hoe verzend ik HKD met MyHkdWallet CX? ',
HELP_4CX_Desc_1             : 'Ten eerste heb je een wallet nodig. Zodra je die hebt, heb je 2 opties: De "VerzendSnel" functionaliteit vanuit het Chrome Extensie icoon of de "Verzend HKD en Tokens" pagina. ',
...
HELP_4CX_Desc_12            : 'Maak gebruik van de "Verzend HKD en Tokens" Pagina ',
...
HELP_8CX_Title              : '8) Wat gebeurd er als MyHkdWallet CX verdwijnt? ',
...
HELP_8CX_Desc_2             : 'Dat gezegd hebbende, is het dan ook **erg belangrijk** dat je een back-up maakt van je wallets die met MyHkdWallet CX zijn gegenereerd. Als er iets met MyHkdWallet CX of jouw computer gebeurd blijft op die manier je wallet bewaard, en heb alle noodzakelijke informatie bij de hand om toegang tot je HKD te verkrijgen. Zie vraag #2a om te leren hoe een back-up van je wallet kunt maken. ',
HELP_8CX_Desc_3             : 'Als om wat voor reden dan ook MyHkdWallet CX verdwijnt van de Chrome Store, kunt je het altijd nog handmatig laden met de broncode van Github. Zie #5 hierboven. ',

HELP_9_Title                : '9) Is de "Verzend HKD en Tokens" pagina offline? ',
...
HELP_13_Desc_1              : 'Dit betekend dat je account onvoldoende HKD bevat om de kosten voor het vereiste gas te dekken. Elke transactie (inclusief token en contract transacties) vereisen gas en dit gas wordt betaald in HKD. Het weergegeven nummer is de hoeveelheid die voor de transactie vereist in Wei. Neem dit nummer, deel het door `1000000000000000000`, en trek daarvan de hoeveelheid HKD die je probeerde te verzenden af (als je probeerde HKD te versturen). Dit geeft je de hoeveelheid HKD die je dient te versturen naar het account om de transactie te maken. ',
...
HELP_15_Desc_1              : 'Adresen zullen enkel in een blockchain explorer worden weergegeven zodra er activiteit op een account heeft plaats gevonden. Bijvoorbeeld, zodra je er wat HKD naar toe verzonden hebt. ',
...
HELP_SecCX_Title            : 'Beveiliging - MyHkdWallet CX ',
