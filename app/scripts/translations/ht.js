...
GAS_PRICE_Desc              : 'Le prix du gaz est le montant que vous payez par unité de gaz. `frais de TX  = prix du gaz * limite en gaz` & est payé aux mineurs pour inclure votre transaction à un bloc. Prix de gaz plus haut = transaction plus rapide, mais plus coûteuse. Le prix par défaut est de `12 GWEI`.',
...
/* Header */
CX_Tagline                  : 'EKSTANSYON CHROME BOUS d\'HKD Open Source JavaScript POU KLIYAN  AN ',
...
MEW_Tagline                 : 'BOUS d\'HKD Open Source JavaScript POU KLIYAN AN ',
...
MYWAL_Content_3             : 'SI W’ VLE SÈVI AK BOUS SA  AVÈK MyHkdWallet CX NAN LÒT JOU YO, OU DWE METE L’ ANKÒ  SÈVI AK KLE SEKRÈ A /PAJ JSON AK KÒD SEKRÈ A ',
