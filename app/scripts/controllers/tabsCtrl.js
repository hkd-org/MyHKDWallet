...
var tabsCtrl = function($scope, globalService, $translate, $sce) {
  ...
  $scope.gasChanged = function() {
    ...
    $scope.gasPriceMsg = ethFuncs.gasAdjustment < 12 ? true : false;
  };
  var setGasValues = function() {
    $scope.gas = {
      curVal: 12,
      value: globalFuncs.localStorage.getItem(gasPriceKey, null) ? parseInt(globalFuncs.localStorage.getItem(gasPriceKey)) : 12,
      max: 99,
      min: 1,
      step: 1
    };
