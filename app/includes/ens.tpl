      ...
      <article class="row">
        <section class="col-xs-12 col-sm-6 col-sm-offset-3 text-center">
          <div>
            ...
            <div class="input-group-btn"><button ng-show="data.available" ng-click="registerSubName($index)" class="btn btn-primary btn-primary-buy-button">Buy ({{data.EthVal}} HKD)
            </button>
  ...
  <article class="row" ng-show="objSub.showBuy">
    <section class="clearfix collapse-container">
      <div class="text-center" ng-click="wd = !wd">
        ...
        <h5 traslate="SWAP_unlock">Unlock your wallet to buy {{objSub.buy.fullName}} for {{objSub.buy.EthVal}} HKD</h5>
      </div>
      <div ng-show="!wd">
